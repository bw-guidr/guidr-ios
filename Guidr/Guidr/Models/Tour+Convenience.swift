...
extension Tour {
    @discardableResult convenience init(title: String?, description: String?, miles: Int32, date: Date, userID: Int32, imageURL: String, location: String, tourType: String, context: NSManagedObjectContext = CoreDataStack.shared.mainContext) {
